...
# Usage: curl -fsSL https://raw.githubusercontent.com/YOURUSERNAME/YOURREPO/main/setup.sh | sudo bash
...
apt-get install -y curl git htop ncdu ufw openssh-server avahi-daemon
